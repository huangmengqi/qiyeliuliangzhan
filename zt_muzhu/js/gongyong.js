...
function showDiv(innerCall){
    ...
    if(document.getElementById('PcPoPmarket')==null)return;
		...
		document.getElementById('PcPoPmarket').style.width = 308+'px';

		document.getElementById('PcPoPmarket').style.height = 206+'px'; 
